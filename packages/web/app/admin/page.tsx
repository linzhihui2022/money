...
import { addDays, addMonths, endOfWeek, isValid, startOfMonth, startOfWeek } from "date-fns"
...
export default async function Page({ searchParams }: { searchParams: Promise<{ date: string }> }) {
    ...
    const date = isValid(new Date(dateFromSearchParams)) ? new Date(dateFromSearchParams) : new Date()
    ...
    return (
        <TaskPanelProvider initialTasks={tasks} initialFoods={foods} initialCookbooks={cookbooks} activeWeek={weeks[0]}>
