    ...
    <div className="flex justify-end">
      ...
      <Button
        ...
        onClick={() => {
          ...
          setValueAction([
            ..._steps,
            { content: "", phase: step.phase, key: v4() },
            ...tail,
          ]);
        }}
      >
...
const PhaseSelect = (props: ComponentProps<typeof Select>) => {
  ...
  return (
    <Select {...props}>
      ...
      <SelectContent>
        <SelectItem value={CookbookStepPhase.PREPARE}>
          {t(CookbookStepPhase.PREPARE)}
        </SelectItem>
        <SelectItem value={CookbookStepPhase.PROGRESS}>
          {t(CookbookStepPhase.PROGRESS)}
        </SelectItem>
        <SelectItem value={CookbookStepPhase.DONE}>
          {t(CookbookStepPhase.DONE)}
        </SelectItem>
      </SelectContent>
    </Select>
  );
    ...
    return (
      <div className="grid grid-cols-12 gap-2">
        <div className="col-span-7">
          <PhaseSelect
            value={init.phase}
            onValueChange={(phase: CookbookStepPhase) =>
              setInit((v) => ({ ...v, phase: phase }))
            }
          />
        </div>
        <div className="col-span-12">
          <Textarea
            value={init.content}
            onChange={(e) =>
              setInit((v) => ({ ...v, content: e.target.value }))
            }
          />
        </div>
        <div className="col-span-12">
